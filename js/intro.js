  ...
  function _introForElement(targetElm) {
    ...
    if(_addOverlayLayer.call(self, targetElm)) {
      ...
      var skipButton     = targetElm.querySelector('.introjs-skipbutton'),
          nextStepButton = targetElm.querySelector('.introjs-nextbutton btn btn-outline-secondary btn-sm');
  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      skipTooltipButton.className = 'introjs-skipbutton btn btn-outline-danger btn-sm';
    ...
    if (this._currentStep == 0 && this._introItems.length > 1) {
      ...
      if (typeof nextTooltipButton !== "undefined" && nextTooltipButton != null) {
        nextTooltipButton.className = 'introjs-nextbutton btn btn-outline-secondary btn-sm';
      }

      if (this._options.hidePrev == true) {
        if (typeof prevTooltipButton !== "undefined" && prevTooltipButton != null) {
          prevTooltipButton.className = 'introjs-prevbutton btn btn-outline-secondary btn-sm introjs-hidden';
        }
        if (typeof nextTooltipButton !== "undefined" && nextTooltipButton != null) {
        ...
        if (typeof prevTooltipButton !== "undefined" && prevTooltipButton != null) {
          prevTooltipButton.className = 'introjs-prevbutton btn btn-outline-secondary btn-sm introjs-disabled';
        }
      }
      ...
      if (typeof prevTooltipButton !== "undefined" && prevTooltipButton != null) {
        prevTooltipButton.className = 'introjs-prevbutton btn btn-outline-secondary btn-sm';
      }

      if (this._options.hideNext == true) {
        if (typeof nextTooltipButton !== "undefined" && nextTooltipButton != null) {
          nextTooltipButton.className = 'introjs-nextbutton btn btn-outline-secondary btn-sm introjs-hidden';
        }
        if (typeof prevTooltipButton !== "undefined" && prevTooltipButton != null) {
        ...
        if (typeof nextTooltipButton !== "undefined" && nextTooltipButton != null) {
          nextTooltipButton.className = 'introjs-nextbutton btn btn-outline-secondary btn-sm disabled';
        }
      }
